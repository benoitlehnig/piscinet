...
@Component({
	selector: 'app-piscinist-portal',
	templateUrl: './piscinist-portal.page.html',
	styleUrls: ['./piscinist-portal.page.scss'],
})
export class PiscinistPortalPage implements OnInit {
